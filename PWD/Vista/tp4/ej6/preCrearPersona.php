             ...
             <div class="container text-center d-flex justify-content-center flex-column">
                 <?php
                    if (!$existe) { ?>
                     ...
                     <div class="group-row">
                         <form id="formulario" class="container mt-4 p-4 border rounded shadow-sm w-50" action="accionCrearPersona.php" method="post">
                             ...
                             <div class="row mb-3">
                                 <div class="col-md-6">
                                     ...
                                     <div class="invalid-feedback">El teléfono solo puede contener números y guiones.</div>
                                 </div>
                                 <div class="col-md-6">
