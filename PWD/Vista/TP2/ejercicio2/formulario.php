...
<body>
  ...
  <div class="d-flex justify-content-center align-items-center">
    <form action="./resultado.php" method="post" class="needs-validation p-4 border rounded shadow w-25 position-relative">
      ...
      <input type="submit" class="btn btn-primary form-control" style="background-color: #2ce673ff; border-color:#2ce673ff" value="Login">
    </form>
  </div>
