...
<body>
    ...
    <form action="./resultado.php" method="get">
        ...
        <div class="radios">
            <label for="secundario"><input type="radio" name="estudios" value="secundario" id="secundario" required>
                Estudios Secundarios</label>
            <label for="primario"><input type="radio" name="estudios" value="primario" id="primario" required>
                Estudios Primarios</label>
            <label for="incompleto"><input type="radio" name="estudios" value="sin estudios" id="incompleto" required>
                No tiene estudios</label>
        </div>
        <p style="font-size: 20px">Seleccione su sexo</p>
        <div class="radios">
            <label for="masculino"><input type="radio" name="sexo" value="masculino" id="masculino" required>
                Masculino</label>
            <label for="femenino"><input type="radio" name="sexo" value="femenino" id="femenino" required>
                Femenino</label>
            <label for="noDicho"><input type="radio" name="sexo" value="no especificado" id="noDicho" required>
